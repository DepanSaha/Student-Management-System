...
public class StudentSnapshot extends JDialog
{
    ...
    public StudentSnapshot()
    {
        try
        {
            ...
            rst = smt.executeQuery("SELECT SM.STUDENT_ID,NAME,COURSE,SEMESTER,GRADE FROM STUDENT_MASTER AS SM,STUDENT_GRADE AS SG WHERE SM.STUDENT_ID=SG.STUDENT_ID ORDER BY SM.STUDENT_ID,SEMESTER");
            while(rst.next())
            {
